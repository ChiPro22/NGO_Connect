...
const NgoProfile = () => {
  ...
  useEffect(() => {
    const fetchNgoData = async () => {
      try {
        ...
        const res = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/ngos/me`, config);
  ...
  const onSubmit = async (e) => {
    ...
    try {
        ...
        await axios.put(`${import.meta.env.VITE_BACKEND_URL}/api/ngos/me`, updatedData, config);
