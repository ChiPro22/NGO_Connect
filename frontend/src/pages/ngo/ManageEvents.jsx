...
const ManageEvents = () => {
    ...
    const fetchNgoCampaigns = async () => {
        try {
            ...
            const res = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/campaigns/my-campaigns`, config);
    ...
    const handleCreateCampaign = async (e) => {
        ...
        try {
            ...
            await axios.post(`${import.meta.env.VITE_BACKEND_URL}/api/campaigns`, body, config);
    ...
    const handleUpdateCampaign = async (e) => {
        ...
        try {
            ...
            await axios.put(`${import.meta.env.VITE_BACKEND_URL}/api/campaigns/${editingCampaign._id}`, body, config);
